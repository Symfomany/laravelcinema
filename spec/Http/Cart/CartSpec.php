...
class CartSpec extends ObjectBehavior
{
     ...
     * @param \App\Http\Cart\MoviesItem $movieitem
     */
    function it_all_cart(MoviesItem $movieitem, MoviesItem $movieitem2){
        $item = new MoviesItem(3);
     ...
     * Countable in cart
     */
    function it_additems(ItemInterface $item, ItemInterface $item2){
