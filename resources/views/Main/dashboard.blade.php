...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="panel">
                <div class="panel-heading">
                    <span class="panel-title fw600 text-info">Répartition des commentaires</span>
                ...
                <div class="panel-body">
                    ...
                    <span class="fs11 text-muted ml10">
                      <i class="fa fa-circle text-primary fs12 pr5"></i> Inacatifs</span>
                    </div>
                    <div class="row">
                        <div class="col-md-4 text-center">
                            <div class="info-circle" id="c1"  value="80" data-circle-color="primary"><div class="circles-wrp" style="position: relative; display: inline-block;"><svg xmlns="http://www.w3.org/2000/svg" width="120" height="120"><path fill="transparent" stroke="#DDD" stroke-width="14" d="M 59.98920532020416 7.00000109929352 A 53 53 0 1 1 59.92638406328221 7.000051125554265 Z"></path><path fill="transparent" stroke="#4a89dc" stroke-width="14" d="M 59.98920532020416 7.00000109929352 A 53 53 0 1 1 9.58170403296166 43.66000514748778 "></path></svg><div class="circle-text"><h2 class="circle-text-value" style="font-size: 30px;">80</h2><p></p></div></div></div>
                        </div>
                        <div class="col-md-4">
                            <div class="info-circle" id="c2"  value="30" data-circle-color="info"><div class="circles-wrp" style="position: relative; display: inline-block;"><svg xmlns="http://www.w3.org/2000/svg" width="120" height="120"><path fill="transparent" stroke="#DDD" stroke-width="14" d="M 59.98920532020416 7.00000109929352 A 53 53 0 1 1 59.92638406328221 7.000051125554265 Z"></path><path fill="transparent" stroke="#3bafda" stroke-width="14" d="M 59.98920532020416 7.00000109929352 A 53 53 0 0 1 110.42494782211868 76.31945578555266 "></path></svg><div class="circle-text"><h2 class="circle-text-value" style="font-size: 30px;">30</h2><p></p></div></div></div>
                        </div>
                        <div class="col-md-4">
                            <div class="info-circle" id="c3"  value="55" data-circle-color="warning"><div class="circles-wrp" style="position: relative; display: inline-block;"><svg xmlns="http://www.w3.org/2000/svg" width="120" height="120"><path fill="transparent" stroke="#DDD" stroke-width="14" d="M 59.98920532020416 7.00000109929352 A 53 53 0 1 1 59.92638406328221 7.000051125554265 Z"></path><path fill="transparent" stroke="#f6bb42" stroke-width="14" d="M 59.98920532020416 7.00000109929352 A 53 53 0 1 1 43.670274342266396 110.42162294039291 "></path></svg><div class="circle-text"><h2 class="circle-text-value" style="font-size: 30px;">55</h2><p></p></div></div></div>
                        </div>
                    </div>
                </div>
            </div>
