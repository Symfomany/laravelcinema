                ...
                <div class="col-md-12">
                        ...
                        <div class="panel">
                                ...
                                <div class="panel-heading">
                                        <span class="panel-title"><i class="fa fa-plus"></i> Edition de film</span>
                                </div>
                                ...
                                <div class="panel-body">
                                        ...
                                        <form enctype='multipart/form-data'  novalidate method="post" action="{{ route('movies_store') }}"  id="form-validate"  enctype="multipart/form-data">
                                                        ...
                                                        <div class="col-md-3">
                                                                <div class="form-group">
                                                                        ...
                                                                        <select name="type" class="form-control">
                                                                                <option @if($movie->type == "long-metrage") selected @endif value="long-metrage">Long-Métrage</option>
                                                                                <option @if($movie->type == "court-metrage") selected @endif value="court-metrage">Court-Métrage</option>
                                                                        </select>
                                                                ...
                                                                <div class="form-group form-group-md">
                                                                        ...
                                                                        <div class="input-group">
                                                                              <span class="input-group-addon">
                                                                                ...
                                                                                <input value="{{ $movie->title }}" required placeholder="Votre titre" type="text"
                                          ...
                                          <span class="input-group-addon">
                                            <i class="fa fa-clock-o"></i>
                                                                ...
                                                                <input value="{{  \Carbon\Carbon::createFromFormat('Y-m-d',$movie->date_release)->format('d/m/Y') }}" required placeholder="dd/mm/YYYY" type="text" name="date_release" class="datepicker form-control">
                                                                </div>
                                                        ...
                                                        <div class="col-md-4">
                                                                <div class="form-group form-group-md">
                                                                        ...
                                                                        @if($movie->image)
                                                                                <img src="{{ $movie->image }}"   class="img-responsive col-md-10" />
                                                                        @endif
                                                                        @if ($errors->has('image'))
                                                                                <p class="help-block text-danger">
                                                                                        {{ $errors->first('image') }}
                                    ...
                                    <textarea placeholder="http://youtube.com" class="gui-textarea"
                                              id="comment" name="trailer" placeholder="Text area">{{ $movie->trailer }}</textarea>
                                          ...
                                          <strong>Video:</strong>Youtube, Dailymotion, Vimeo
                                                        ...
                                                        <div class="form-group">
                                                                ...
                                                                <label class="switch switch-primary">
                                                                        <input @if($movie->visible) checked @endif type="checkbox" name="visible" id="t4" value="1" checked="">
                                                                        <label for="t4" data-on="Oui" data-off="Non"></label>
                                                                        <span>Film visible ?</span>
                                                                </label>
                                                                <label class="switch switch-primary">
                                                                        <input  @if($movie->cover) checked @endif type="checkbox" name="cover" id="t5" value="1" checked="">
                                                                ...
                                                                <div class="row">
                                                                    <span class="rating block">
                                                                      ...
                                                                      <input @if($movie->note_presse == 1) checked @endif value="1" class="rating-input" id="r5" type="radio" name="note_presse">
                                                                      <label class="rating-star" for="r5">
                                                                              <i class="fa fa-star"></i>
                                                                      </label>
                                                                      <input @if($movie->note_presse == 2) checked @endif value="2" class="rating-input" id="r4" type="radio" name="note_presse">
                                                                      <label class="rating-star" for="r4">
                                                                              <i class="fa fa-star"></i>
                                                                      </label>
                                                                      <input  @if($movie->note_presse == 3) checked @endif value="3" class="rating-input" id="r3" type="radio" name="note_presse">
                                                                      <label class="rating-star" for="r3">
                                                                              <i class="fa fa-star"></i>
                                                                      </label>
                                                                      <input  @if($movie->note_presse == 4) checked @endif value="4" class="rating-input" id="r2" type="radio" name="note_presse">
                                                                      <label class="rating-star" for="r2">
                                                                              <i class="fa fa-star"></i>
                                                                      </label>
                                                                      <input  @if($movie->note_presse == 5) checked @endif value="5" class="rating-input" id="r1" type="radio" name="note_presse">
                                                        ...
                                                        <div class="form-group">
                                                                <textarea placeholder="Votre synopsis..." name="synopsis" class="markdown form-control">{{ $movie->synopsis }}</textarea>
                                                        ...
                                                        <div class="form-group">
                                                                <textarea placeholder="Votre description..." name="description" class="wysiwyg form-control">{{ $movie->description }}</textarea>
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                        <div class="form-group">
                                                                                ...
                                                                                <select name="lang" class="form-control form-group-margin">
                                                                                        <option @if($movie->lang == "fr") selected @endif value="fr">Français</option>
                                                                                        <option @if($movie->lang == "en") selected @endif value="en">Anglais</option>
                                                                                        <option @if($movie->lang == "it") selected @endif value="it">Italien</option>
                                                                                        <option @if($movie->lang == "es") selected @endif value="es">Espagnol</option>
                                                                                </select>
                                                                                @if ($errors->has('lang'))
                                                                ...
                                                                <div class="col-md-4">
                                                                        ...
                                                                        <div class="form-group">
                                                                                ...
                                                                                <select name="bo" class="form-control form-group-margin">
                                                                                        <option @if($movie->bo == "vf") selected @endif value="vf">VF</option>
                                                                                        <option @if($movie->bo == "vostfr") selected @endif value="vostfr">VOSTFR</option>
                                                                                        <option @if($movie->bo == "vost") selected @endif value="vost">VOST</option>
                                                                                        <option @if($movie->bo == "vo") selected @endif value="vo">VO</option>
                                                                                </select>
                                                                                @if ($errors->has('bo'))
                                                                ...
                                                                <div class="col-md-4">
                                                                        ...
                                                                        <div class="form-group">
                                                                                ...
                                                                                <input placeholder="ex: Warner Bros" name="distributeur" value="{{ $movie->distributeur }}" class="form-control">
                                                                ...
                                                                <div class="col-md-4">
                                                                        ...
                                                                        <div class="form-group">
                                                                                ...
                                                                                <input  type="text" name="duree" value="{{ $movie->duree }}" class="slider-countbox form-control" id="duree">
                                                                ...
                                                                <div class="col-md-4">
                                                                        <div class="form-group">
                                                                                ...
                                                                                <input placeholder="ex: 50 000 000€" type="text" name="budget" value="{{ $movie->budget }}" class="form-control" id="budget">
                                                                ...
                                                                <div class="col-md-4">
                                                                        <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="annee" value="{{ $movie->annee }}" class="form-control" id="annee" placeholder="2015">
                                                                ...
                                                                <div class="col-md-4">
                                                                        ...
                                                                        <div class="form-group">
                                                                                <div class="col-sm-10">
                                                                                        <select name="categories_id" class="form-control form-group-margin">
                                                                                                @foreach($categories as $categorie)
                                                                                                        <option @if($categorie->id == $movie->categories_id) selected @endif  value="{{ $categorie->id }}">{{ $categorie->title }}</option>
                                                                                                @endforeach
                                                                                        </select>
                                                                                ...
                                                                                <div class="col-sm-10">
                                                                                        <select name="actors[]"  multiple="multiple" class="form-control form-group-margin">
                                                                                                @foreach ($actors as $actor)
                                                                                                        <option @if(in_array($actor->id, array_column($movie->actors->toArray(), 'id') )) selected @endif value="{{ $actor->id }}">{{ $actor->firstname }} {{ $actor->lastname }}</option>
                                                                                                @endforeach
                                                                                        </select>
                                                                                ...
                                                                                <div class="col-sm-10">
                                                                                        <select name="directors[]" multiple="multiple" class="">
                                                                                                @foreach ($directors as $director)
                                                                                                        <option  @if(in_array($director->id, array_column($movie->directors->toArray(), 'id') )) selected @endif  value="{{ $director->id }}">{{ $director->firstname }} {{ $director->lastname }}</option>
                                                                                                @endforeach
                                                                                        </select>
